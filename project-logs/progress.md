...
- `node create_releases.js` — Published tagged releases with authentic release notes onto GitHub.
...
- `git push origin master --tags` — Synchronized master branch and release tags to GitHub.
